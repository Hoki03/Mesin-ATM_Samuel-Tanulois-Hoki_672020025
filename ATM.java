 ...
 */
 ...
 public class ATM{
	...
	public static void main (String [] args)throws IOException {
		...
		int i=0;
                int b=0;
		int pilihan, pilihan2, tabung, saldo = 500000, ambil, isi, index=0, index2=0;
                int[] tambah_saldo=new int[20], tarik_saldo=new int[20];
		for(i=0; i<=2; i++){
			
			System.out.println("=================================================");
			System.out.println("          Selamat Datang Di ATM Makmur           ");
                        System.out.println("=================================================");
			...
			if( (user.equalsIgnoreCase("Hoki")) && (password==672020025) ){
				...
				switch (pilihan) {
					...
					do{
                                            ...
                                            if(b==0){
                                                ...
                                                System.out.println("  Minimal Harus Kelipatan 50000  ");
                                                System.out.println("=================================================");
                                                System.out.println("\n1.keluar");
                                                System.out.println("2.Kembali");
                                                System.out.print("\nPilih Menu : ");
